...
public class SysDictItemController {
	...
	public Result<List<ClassificationVo>> queryclassificationList() {
		List<ClassificationVo>  list= sysDictItemService.selectList();
	 ...
	 * @return
	 */
	@RequestMapping(value = "/list/datasetTags", method = RequestMethod.GET)
	@ApiOperation("字典重复校验接口")
	public Result<Object> qryDatasetTagsList(@RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
											 @RequestParam(name="pageSize", defaultValue="10") Integer pageSize) {
		List<JSONObject> tagsList = sysDictItemService.datasetTagsList();
	 ...
	 * @return
	 */
	@RequestMapping(value = "/list/datasetClass", method = RequestMethod.GET)
	@ApiOperation("字典重复校验接口")
	public Result<Object> qryDatasetClassList(@RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
											 @RequestParam(name="pageSize", defaultValue="10") Integer pageSize) {
		List<JSONObject> tagsList = sysDictItemService.datasetClassList();
		return Result.OK(tagsList);
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/list/segmentClass", method = RequestMethod.GET)
	@ApiOperation("字典重复校验接口")
	public Result<Object> qrySegmentClassList(@RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
											  @RequestParam(name="pageSize", defaultValue="10") Integer pageSize) {
		List<JSONObject> tagsList = sysDictItemService.segmentClassList();
		return Result.OK(tagsList);
	}
}
