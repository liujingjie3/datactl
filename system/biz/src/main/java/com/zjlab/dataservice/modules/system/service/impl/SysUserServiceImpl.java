...
import com.zjlab.dataservice.common.constant.FillRuleConstant;
import com.zjlab.dataservice.common.constant.SymbolConstant;
import com.zjlab.dataservice.common.util.FillRuleUtil;
import com.zjlab.dataservice.common.util.PasswordUtil;
...
import com.zjlab.dataservice.modules.system.service.ISysUserRoleService;
...
import com.zjlab.dataservice.common.desensitization.annotation.SensitiveEncode;
import com.zjlab.dataservice.common.exception.JeecgBootException;
import com.zjlab.dataservice.common.system.vo.LoginUser;
import com.zjlab.dataservice.common.system.vo.SysUserCacheInfo;
...
import com.zjlab.dataservice.modules.system.vo.SysUserDepVo;
import com.zjlab.dataservice.modules.system.vo.UserAvatar;
import com.zjlab.dataservice.modules.system.vo.lowapp.DepartAndUserInfo;
import com.zjlab.dataservice.modules.system.vo.lowapp.DepartInfo;
import com.zjlab.dataservice.modules.system.vo.lowapp.UpdateDepartInfo;
...
/*	@Override
    ...
    @Override
    public Integer getUserNumberByRoleId(String roleId) {
        return userMapper.getUserNumberByRoleId(roleId);
    }
...
//		this.save(user);  //保存角色的时候已经添加过一次了
    ...
    public LoginUser getEncodeUserInfo(String username) {
        ...
        //查询用户的租户ids
        this.setUserDepartNames(loginUser);
        return loginUser;
    }
     ...
     * @param loginUser
     */
    private void setUserDepartNames(LoginUser loginUser) {
        if (ObjectUtils.isNotEmpty(loginUser)) {
            List<SysDepart> list = sysDepartMapper.queryUserDeparts(loginUser.getId());
            if (null != list && list.size() > 0) {
                loginUser.setDepartNames(StringUtils.join(list.stream().map(i -> i.getDepartName()).toArray(), ","));
            } else {
                loginUser.setDepartNames("");
            }
        }
    }
