...
import com.zjlab.dataservice.modules.system.entity.SysRolePermission;
...
public class SysRoleController {
    ...
    public Result<SysRole> add(@RequestBody SysRole role) {
        ...
        try {
            ...
            role.setStatus(1);
            role.setDelFlag(CommonConstant.DEL_FLAG_0);
    ...
    public Result<List<SysRole>> queryall() {
        ...
        if (list == null || list.size() <= 0) {
            ...
            list.parallelStream().forEach(item -> {
                //roleId
                item.setNumbers(sysUserService.getUserNumberByRoleId(item.getId()));
            });
