...
public class JeecgBootExceptionHandler {
	...
	public Result<?> MethodArgumentNotValidException(MethodArgumentNotValidException e){
		...
		return Result.error(ResultCode.PARA_ERROR.getCode(),errorMessage);
	}

	@ExceptionHandler(HttpMessageNotReadableException.class)
	public Result<?> MethodHttpMessageNotReadableException(HttpMessageNotReadableException e){
		log.error(e.getMessage());
		return Result.error(ResultCode.REQUEST_BODY_MISSING_ERROR.getCode(),ResultCode.REQUEST_BODY_MISSING_ERROR.getMessage());
	}
