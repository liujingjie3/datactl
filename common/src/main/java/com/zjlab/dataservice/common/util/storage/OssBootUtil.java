...
//            ossClient.setBucketAcl(newBucket, CannedAccessControlList.PublicRead);
    ...
    */
    ...
    public static void download(){
        ...
        AmazonS3 s3 = generateAmazonS3Client();
        String key = "MD5-test.txt";
        String bucketname = "1130test";
        String downloadFilePath = "C:\\Users\\OptiPlex 7070\\Desktop\\download\\test.txt";
        TransferManager transferManager = new TransferManager(s3);
        Download download = transferManager.download(bucketname, key,
    ...
    public static AmazonS3 generateAmazonS3Client(){
        String accessKey = "123456";
        String secretKey = "123456";
        String endpoint = "s3n22.zjstor.com:8009";
        ...
        configuration.withUseExpectContinue(false);
