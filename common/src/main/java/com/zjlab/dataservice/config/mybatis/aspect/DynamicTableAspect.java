package com.zjlab.dataservice.config.mybatis.aspect;

import com.zjlab.dataservice.common.constant.CommonConstant;
import com.zjlab.dataservice.config.mybatis.ThreadLocalDataHelper;
import org.aspectj.lang.ProceedingJoinPoint;
import org.aspectj.lang.annotation.Around;
import org.aspectj.lang.annotation.Aspect;
import org.aspectj.lang.annotation.Pointcut;
import org.aspectj.lang.reflect.MethodSignature;
import com.zjlab.dataservice.common.aspect.annotation.DynamicTable;
...
public class DynamicTableAspect {
     ...
     * 定义切面拦截切入点
     */
    @Pointcut("@annotation(com.zjlab.dataservice.common.aspect.annotation.DynamicTable)")
